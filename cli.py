...
def main():
    ...
    # Vérification Gemini (chemin absolu : le CLI peut être lancé depuis n'importe quel dossier)
    gemini_slot_1 = os.path.join(BASE_DIR, ".secrets", "gemini_slot_1.json")
    if os.path.exists(gemini_slot_1):
